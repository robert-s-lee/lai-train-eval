...
class App_UI(L.LightningFlow):
  def __init__(self, *args, **kwargs):
    ...
    self.train_args = '--trainer.max_epochs=3 --trainer.limit_val_batches=4 --trainer.limit_train_batches=12 --trainer.callbacks=ModelCheckpoint --trainer.callbacks.monitor=val_acc --data.num_workers=2'
